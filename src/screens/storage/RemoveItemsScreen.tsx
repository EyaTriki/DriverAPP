...
interface RemoveItemsScreenProps {
    navigation: any;
    route: any;
}

const RemoveItemsScreen: React.FC<RemoveItemsScreenProps> = () => {
    ...
    const handleRemoveItems = () => {
        ...
        console.log('Removing items with data:', {
            date: selectedDate,
        ...
        <View className="flex-1 bg-backgroundScreen">
            ...
            <View className="pt-12 pb-8 px-5">
                <View className="flex-row items-center">
                    ...
                    <Text className="text-xl font-bold text-gray-900">Remove Items </Text>
                </View>
            </View>
...
RemoveItemsScreen.displayName = 'RemoveItemsScreen';
